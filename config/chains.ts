...
export const CHAIN_COLOR: { [key in NETWORKS]: string } = {
  ...
  [NETWORKS.GIWA]: '#000000',
  [NETWORKS.PLASMA]: '#000000',
  [NETWORKS.GATELAYER]: '#000000',
...
export const getChainByChain = (chain: ChainId) =>
