        ...
        <div className="w-full flex flex-col gap-8">
            ...
            <div className="flex items-center gap-[6px] w-full px-5 justify-center">
              ...
              `}
                        >
                                ...
                                <div
                                    className={`flex items-center justify-center ${
                                        filter.name === "All chains"
                                            ? "w-[17px] h-[17px] rounded-full bg-[rgba(16,16,16,0.7)]"
                                            : "w-[17px] h-[17px]"
                                    }`}
                                >
                                    <Image
                            ...
                            <span className="text-sm font-medium text-[#030303] font-inter">
                                {filter.name}
                            </span>
                        </button>
                    ))}
            ...
            <div className="flex items-center justify-between h-[57px] border-b border-[rgba(230,230,230,0.8)] bg-white">
              ...
              `}
                    ...
                    {/* Divider */}
                    {/* <span className="text-[18px] font-normal text-[rgba(3,3,3,0.6)] font-poppins">
                        |
                    </span> */}
